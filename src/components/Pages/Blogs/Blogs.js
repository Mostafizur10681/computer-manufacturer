...
const Blogs = () => {
    return (
        <article className='my-24'>
            <blockquote class="card mx-auto w-3/5 bg-base-100 mb-8 shadow-2xl">
                <div class="card-body">
                    <h2 class="card-title text-blue-900 text-lg lg:text-2xl ">How will you improve the performance of a React Application?</h2>
                    <p className='text-sm lg:xl'>To get the best React rendering, ensure sure components only get the props they need.
            ...
            <blockquote class="card mx-auto w-3/5 bg-base-100 mb-8 px-12 shadow-2xl">
                <div class="card-body">
                    <h2 class="card-title text-blue-900 text-lg lg:text-2xl">What are the different ways to manage a state in a React application?</h2>
                    <p className='text-sm lg:xl'>There are four main types of state you need to properly manage in your React apps:
                        <br />
            ...
            <blockquote class="card mx-auto w-3/5 bg-base-100 mb-8 px-12 shadow-2xl">
                <div class="card-body ">
                    <h2 class="card-title text-blue-900 text-lg lg:text-2xl"> How does prototypical inheritance work?</h2>
                    <p className='text-sm lg:xl'>Prototypical inheritance refers to the ability to access object properties from another object.
            ...
            <blockquote class="card mx-auto w-3/5 bg-base-100 mb-8 px-12 shadow-2xl">
                <div class="card-body ">
                    <h2 class="card-title text-blue-900 text-lg lg:text-2xl"> Why you do not set the state directly in React?</h2>
                    <p className='text-sm lg:xl'>It should not update directly because If you update it directly, executing setState() thereafter may just overwrite your changes.
            ...
            <blockquote class="card mx-auto w-3/5 bg-base-100 mb-8 px-12 shadow-2xl">
                <div class="card-body ">
                    <h2 class="card-title text-blue-900 text-lg lg:text-2xl"> What is a unit test? Why should write unit tests?</h2>
                    <p className='text-sm lg:xl'>Unit testing allows the programmer to rewrite code later and ensure that the module continues to function properly .
